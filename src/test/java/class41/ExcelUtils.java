...
public class ExcelUtils {
     ...
     * @param xlsheet Name of the sheet.
    ...
    /**
     * Returns the cell count in a row of a sheet.
     * @param xlfile Path to the Excel file.
     * @param xlsheet Name of the sheet.
     ...
     * @return Data from the specified cell as a String.
     * @throws IOException If an I/O error occurs.
     */
